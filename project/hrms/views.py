...
class Attendance_New(LoginRequiredMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        pstaff = Attendance.objects.filter(~Q(status=None) & Q(date=timezone.localdate()))
...
class RecruitmentNew(SuccessMessageMixin, CreateView):
    model = Recruitment
    template_name = 'hrms/recruitment/index.html'
    form_class = RecruitmentForm
    success_url = reverse_lazy('hrms:recruitment')
    success_message = "%(first_name)s, your Application has been sent successfully."
